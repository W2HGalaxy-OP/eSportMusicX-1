...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/215f17601572293033070.jpg"
            ...
            [
                [
                    InlineKeyboardButton(
                        text="𝗖𝗵𝗮𝗻𝗻𝗲𝗹", url=f"https://t.me/w2hsupport"
                    ),
                    InlineKeyboardButton(text="𝗚𝗿𝗼𝘂𝗽", url=f"https://t.me/w2hsupport"),
                ]
            ]
        )
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="𝗚𝗿𝗼𝘂𝗽", url=f"https://t.me/w2hsupport"
                        ),
                    ]
                ]
            )
